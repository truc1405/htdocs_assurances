...
<script type="text/javascript">
	...
	function toggleFull(){
		...
		if(PQP_HEIGHT == "notfull"){
			addClassName(container, 'showFull', true);
			PQP_HEIGHT = "full";
		}
		else{
			removeClassName(container, 'showFull');
			PQP_HEIGHT = "notfull";
		}
	}
...
echo '<div id="pqp-container" class="pQp showFull" style="display:none">';
	...
	<table id="pqp-footer" cellspacing="0">
		<tr>
			...
			<td class="actions">
				...
				<a class="FullToggle" href="#" onclick="toggleFull();return false">Fullsize</a>
			</td>
		</tr>
	</table>
FOOTER;
